...
import bgImage from '@/assets/logo_branca.png';

export default function NavBar() {
  return (
    <nav className="bg-purple-600 px-12 py-1 flex items-center justify-between">
      <img src={bgImage} alt="logo" className="w-36" />
      <div className="flex justify-center items-center gap-x-5">
        <a
          href={`/forum`}
          className="text-sm bg-white px-3 py-1.5 gap-x-2 text-purple-600 rounded-md"
        >
          Home
        </a>
          ...
          <PopoverContent className=" mr-10 mt-2">
            <div className="bg-white min-w-40 text-sm rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_4px_8px]">
              ...
              <div className="p-2 gap-y-2 flex flex-col">
                ...
                <a
                  href={`/perfil`}
                  className=" px-3 py-1 hover:bg-zinc-200 rounded-lg "
                >
                  Perfil
                </a>
